...
struct qt_meta_stringdata_apple_t {
    QByteArrayData data[1];
    char stringdata[6];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_apple_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_apple_t qt_meta_stringdata_apple = {
    {
QT_MOC_LITERAL(0, 0, 5) // "apple"
...
const QMetaObject apple::staticMetaObject = {
    { &object::staticMetaObject, qt_meta_stringdata_apple.data,
      qt_meta_data_apple,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *apple::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_apple.stringdata))
