/****************************************************************************
** Meta object code from reading C++ file 'banana.h'
**
...
#error "The header file 'banana.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_banana_t, stringdata) + ofs \
...
const QMetaObject banana::staticMetaObject = {
    { &object::staticMetaObject, qt_meta_stringdata_banana.data,
      qt_meta_data_banana,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *banana::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_banana.stringdata))
        return static_cast<void*>(const_cast< banana*>(this));
